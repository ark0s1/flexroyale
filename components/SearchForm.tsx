      ...
      <div className="relative">
        <div className={cn('flex gap-3', compact ? 'flex-row' : 'flex-col sm:flex-row')}>
          <div className="relative flex-1">
            <span className="absolute left-4 top-1/2 -translate-y-1/2 text-blue-400 font-black text-lg select-none font-gaming">
              #
            </span>
            <input
              type="text"
              ...
              className={cn(
                ...
                compact ? 'py-2 text-sm rounded-xl' : 'py-4 text-lg rounded-xl',
      ...
      {!compact && (
        <div className="mt-4 flex items-center justify-center gap-4">
          ...
          <div className="relative">
            ...
            {showTooltip && (
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 glass-card p-4 text-sm text-gray-300 shadow-xl z-10">
                <p className="font-bold text-white mb-2 font-gaming">{t.searchTooltipTitle}</p>
